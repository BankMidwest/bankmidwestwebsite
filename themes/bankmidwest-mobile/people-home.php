...
<div id="main">
    ...
    <div id="content">
        ...
        <div id="inner-content">
			...
			<ul id="directory">
				<li class="bank"  style='clear:left;'><a href="<?php echo get_permalink(117); ?>"><i></i>BANK<span>one place</span></a>
					<div class="outer"><div class="inner"><p>From account opening to online management. Bank on us.</p></div></div>	
                </li>
				<li class="borrow"><a href="<?php echo get_permalink(185); ?>"><i></i>BORROW<span>lending</span></a>
					<div class="outer"><div class="inner"><p>Find a lender or mortgage specialist near you.</p></div></div>
				</li>
				<li class="insure"  style='clear:left;'><a href="<?php echo get_permalink(187); ?>"><i></i>INSURE<span>protect</span></a>
					<div class="outer"><div class="inner"><p>Questions about your policy or need a quote? We&#8217;re here for you.</p></div></div>
				</li>
				<li class="grow"><a href="<?php echo get_permalink(189); ?>"><i></i>Plan<span>investments</span></a>
					<div class="outer"><div class="inner"><p>Talk to us about planning for a financially secure future.</p></div></div>
				</li>
				<li class="trust"  style='clear:left;'><a href="<?php echo get_permalink(5961); ?>"><i></i>Trust<span>transition</span></a>
					<div class="outer"><div class="inner"><p>Establish certainty for the future of your estate, farm or business.</p></div></div>
				</li>                
			</ul>
            <div class='clear'></div>
			  <div class="int-text">
						...
						$postcounts = get_posts($args3); 
					 	...
					 	foreach ($postcounts as $postcount) { ?>
							...
							if ($count > 1) { ?>
								...
								<h5 class="branchname"><a href="<?php echo get_permalink($pageID);  ?>#locationinfo">View all Locations ></a></h5>
