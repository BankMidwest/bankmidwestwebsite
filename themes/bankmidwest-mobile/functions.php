...
add_image_size('blog_large', 380, 230, true);
...
add_image_size('mobile_top', 320, 166, true);
add_image_size('mobile_home', 410, 300, true);
...
function fh_jquery_enqueue() {
   ...
   wp_enqueue_script( 'frontend-script', get_template_directory_uri() . '/inc/scripts.js', array( 'jquery' ), '1.0', false );
}
	...
	slt_cf_register_box(array(
		...
		'fields' => array(
			...
			array(
				...
				'type' => 'select',
				'options_type' => 'posts',
				'options_query' => array('post_type' => 'page', 'post_status' => 'publish')
			),
			array(
				'name' => 'page_button',
	...
	slt_cf_register_box(array(
		...
		"fields" => array(
			array(
				...
				"scope" => array( 'page', 'employee', 'location' )
			)
		)
	));
