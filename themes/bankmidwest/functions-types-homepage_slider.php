	...
	slt_cf_register_box(array(
		...
		'fields' => array(
			...
			array(
				...
				array(
				'name' => 'homepage_slider_link',
				'label' => 'Main Image link for this slide',
				'description' => 'Provides the link for the slider image',
				'scope' => array('homepage_slider'),
				'type' => 'text',
				'capabilities' => array('edit_homepage_sliders')
			),
			...
			array(
				...
				'description' => 'Header for the 1st Homepage Slider Button (If there is no header, the button will not display.)',
				'scope' => array('homepage_slider'),
				'type' => 'text',
				'capabilities' => array('edit_homepage_sliders')
			),
			array(
				...
				'description' => 'Text for the 1st Homepage Slider Button',
				'scope' => array('homepage_slider'),
				'type' => 'wysiwyg',
				'capabilities' => array('edit_homepage_sliders')
			),
			...
			array(
				...
				'description' => 'Icon for the 1st Homepage Slider Button',
				'scope' => array('homepage_slider'),
				'type' => 'file',
				'capabilities' => array('edit_homepage_sliders')
			),		
			array(
				...
				'description' => 'Header for the 2nd Homepage Slider Button(If there is no header, the button will not display.)',
				'scope' => array('homepage_slider'),
				'type' => 'text',
				'capabilities' => array('edit_homepage_sliders')
			),
			array(
				...
				'description' => 'Link for the 2nd Homepage Slider Button',
				'scope' => array('homepage_slider'),
				'type' => 'wysiwyg',
				'capabilities' => array('edit_homepage_sliders')
			),
			array(
				...
				'label' => '2nd Button Link',
				'description' => 'Text for the 2nd Homepage Slider Button',
				'scope' => array('homepage_slider'),
				'type' => 'text',
				'capabilities' => array('edit_homepage_sliders')
			),		
			array(
				...
				'description' => 'Icon for the 2nd Homepage Slider Button',
				'scope' => array('homepage_slider'),
				'type' => 'file',
				'capabilities' => array('edit_homepage_sliders')
			)
