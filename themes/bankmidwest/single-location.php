									...
									<tr>
										...
										if($employeeEmail)
										{
											...
											if($form_container_page) { ?>
												<td><a href="<?php echo add_query_arg("employee_id", $employee, get_permalink($form_container_page)); ?>" class="emailLink emailme iframe"><i></i> Contact</a></td>
											<?php
												$rendered_email = true;
											} 
										}
