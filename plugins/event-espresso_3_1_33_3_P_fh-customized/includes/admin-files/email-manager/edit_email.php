			...
			<li>
				...
				<div class="postbox">   
					...
					if (function_exists('wp_editor')) {
						...
						the_editor(espresso_admin_format_content($email_text), $id = 'event_desc', $prev_id = 'title', $media_buttons = true, $tab_index = 3);
					}
					//the_editor(espresso_admin_format_content($email_text), $id = 'email_text', $prev_id = 'title', $media_buttons = true, $tab_index = 3);?>
