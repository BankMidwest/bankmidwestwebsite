...
<div class="wrap">
  <div id="icon-options-event" class="icon32"> </div>
   ...
   <?php  if ( isset( $_REQUEST[ 'action' ] ) &&  'edit' != $_REQUEST[ 'action' ] && 'add_new_locale' != $_REQUEST[ 'action' ] ){
...
if ( isset( $_REQUEST['action'] ) && 'update' == $_REQUEST['action'] ){require_once("update_locale.php");update_event_locale();}
if ( isset( $_REQUEST['action'] ) && 'add' == $_REQUEST['action'] ){require_once("add_locale_to_db.php");add_locale_to_db();}
if ( isset( $_REQUEST['action'] ) && 'add_new_locale' == $_REQUEST['action'] ){require_once("add_new_locale.php");add_new_event_locale();}
if ( isset( $_REQUEST['action'] ) && 'edit' == $_REQUEST['action'] ){require_once("edit_locale.php");edit_event_locale();}
