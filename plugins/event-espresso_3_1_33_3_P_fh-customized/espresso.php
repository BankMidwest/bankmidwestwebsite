<?php
/*
  Plugin Name: Event Espresso (FH-customized)
  Plugin URI: http://eventespresso.com/
  Description: Out-of-the-box Events Registration integrated with PayPal IPN for your WordPress blog/website. <a href="admin.php?page=support" >Support</a>. Adds support for capability-based management (can_administer_event_espresso).
